        ...
        <svg viewBox="0 0 280 210" className="w-full">
          ...
          {ZONES.map((z, i) => (
            <path
              ...
              fill={zoneColors[i]}
              fillOpacity={0.12 + z.rate * 0.75}
            />
          ))}

          {/* 内野土 */}
          <circle cx={cx} cy={cy} r={rInfield + 4} fill="#fef3c7" />
          ...
          {[A_LC_BOUNDARY, A_CR_BOUNDARY].map((deg) => {
            ...
            return (
              <line
                ...
                stroke="rgba(0,0,0,0.12)" strokeWidth="1" strokeDasharray="5,4"
              />
            );
          })}
          ...
          <circle
            ...
            fill="#fde68a" stroke="rgba(0,0,0,0.15)" strokeWidth="0.6"
          />
          ...
          <polygon
            ...
            fill="#ffffff" stroke="rgba(0,0,0,0.2)" strokeWidth="0.5"
          />
          ...
          <div className="flex justify-between px-1 mt-1">
            {ZONES.map((z, i) => (
              <div key={z.label} className="flex items-center gap-1">
                ...
                <span className="text-slate-400 text-[10px]">{z.label} {z.count}本</span>
              </div>
            ))}
          </div>
        ) : (
